...
void I2C_Init(I2C_Handle_t *pI2CHandle)
{
	...
	tempreg|= (1 << 14);   // Bit 14 should always be kept 1 by SW. Mentioned in ref.manual
...
void I2C_MasterReceiveData(I2C_Handle_t *pI2CHandle, uint8_t *pRxBuffer, uint8_t Len, uint8_t SlaveAddr, uint8_t Sr)
{
	...
	if(Len>1)
	{
		...
		for (uint32_t i=Len; i>0; i--)
		{
			...
			if (i==2)  //i.e. if last 2 bytes are remaining
			{
				//Disable Acking
				I2C_ManageAcking(pI2CHandle->pI2Cx, I2C_ACK_DISABLE);
...
static void I2C_MasterHandleRXNEInterrupt(I2C_Handle_t *pI2CHandle)
{
	...
	{
		//close the I2C data deception and notify the application
...
void I2C_EV_IRQHandling(I2C_Handle_t *pI2CHandle)
{
	...
	if (temp1 && temp3)
	{
		...
		//In this block we execute the address phase
